...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExtraGraphLine.identifier_mapping'
        db.add_column('lizard_datasource_extragraphline', 'identifier_mapping',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_datasource.IdentifierMapping'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExtraGraphLine.identifier_mapping'
        db.delete_column('lizard_datasource_extragraphline', 'identifier_mapping_id')
    ...
    models = {
        ...
        'lizard_datasource.extragraphline': {
            ...
            'hide_from_layer': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier_mapping': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lizard_datasource.IdentifierMapping']", 'null': 'True'}),
