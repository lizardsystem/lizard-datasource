...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DatasourceLayer.unit_cache'
        db.add_column('lizard_datasource_datasourcelayer', 'unit_cache',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DatasourceLayer.unit_cache'
        db.delete_column('lizard_datasource_datasourcelayer', 'unit_cache')
    ...
    models = {
        ...
        'lizard_datasource.datasourcelayer': {
            ...
            'unit_cache': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'})
        },
