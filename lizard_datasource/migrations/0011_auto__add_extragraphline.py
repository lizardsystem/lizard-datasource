...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExtraGraphLine'
        db.create_table('lizard_datasource_extragraphline', (
            ...
            ('layer_to_add_line_to', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'extra_graph_line_from', to=orm['lizard_datasource.DatasourceLayer'])),
            ('layer_to_get_line_from', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'extra_graph_line_to', to=orm['lizard_datasource.DatasourceLayer'])),
            ('hide_from_layer', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('lizard_datasource', ['ExtraGraphLine'])


    def backwards(self, orm):
        # Deleting model 'ExtraGraphLine'
        db.delete_table('lizard_datasource_extragraphline')
