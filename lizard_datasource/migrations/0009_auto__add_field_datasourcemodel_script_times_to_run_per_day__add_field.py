...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DatasourceModel.script_times_to_run_per_day'
        db.add_column('lizard_datasource_datasourcemodel', 'script_times_to_run_per_day',
                      self.gf('django.db.models.fields.IntegerField')(default=24),
                      keep_default=False)

        # Adding field 'DatasourceModel.script_last_run_started'
        db.add_column('lizard_datasource_datasourcemodel', 'script_last_run_started',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'DatasourceModel.script_run_next_opportunity'
        db.add_column('lizard_datasource_datasourcemodel', 'script_run_next_opportunity',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DatasourceModel.script_times_to_run_per_day'
        db.delete_column('lizard_datasource_datasourcemodel', 'script_times_to_run_per_day')

        # Deleting field 'DatasourceModel.script_last_run_started'
        db.delete_column('lizard_datasource_datasourcemodel', 'script_last_run_started')

        # Deleting field 'DatasourceModel.script_run_next_opportunity'
        db.delete_column('lizard_datasource_datasourcemodel', 'script_run_next_opportunity')
    ...
    models = {
        ...
        'lizard_datasource.datasourcemodel': {
            ...
            'script_run_next_opportunity': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
