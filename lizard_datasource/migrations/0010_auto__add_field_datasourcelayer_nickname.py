...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DatasourceLayer.nickname'
        db.add_column('lizard_datasource_datasourcelayer', 'nickname',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DatasourceLayer.nickname'
        db.delete_column('lizard_datasource_datasourcelayer', 'nickname')
